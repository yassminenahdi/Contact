...
@Autowired
	...
	@Override
	public double calculerPrime(int contratId, int age) {
			...
			// Vérification du montant pour s'assurer qu'il est valide
			if (montant < 0) {
				throw new IllegalArgumentException("Montant du contrat invalide");
			}

			// Calcul de la prime
			double prime = montant * (1 + (age / 100.0));
			return prime;
		}
